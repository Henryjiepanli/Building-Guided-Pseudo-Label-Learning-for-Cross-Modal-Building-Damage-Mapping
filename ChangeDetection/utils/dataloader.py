...
class Multi_Class_Segmentation_Dataset(data.Dataset):
    def __init__(self, img_A_root, img_B_root, gt_root, trainsize, mode, mosaic_ratio=0.25):
...
def get_loader(img_A_root, img_B_root, gt_root, trainsize, mode, batchsize, mosaic_ratio=0.25, num_workers=4, shuffle=True, pin_memory=True):

    dataset = Multi_Class_Segmentation_Dataset(img_A_root = img_A_root, img_B_root = img_B_root, gt_root = gt_root, trainsize = trainsize, mode = mode, mosaic_ratio=mosaic_ratio)
